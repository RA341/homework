...
abstract class MediaServiceBase extends $pb.GeneratedService {
  $async.Future<$0.AddAndDownloadResponse> addAndDownload(
      $pb.ServerContext ctx, $0.AddAndDownloadRequest request);

  $pb.GeneratedMessage createRequest($core.String methodName) {
    switch (methodName) {
      case 'AddAndDownload':
        return $0.AddAndDownloadRequest();
      default:
  ...
  $async.Future<$pb.GeneratedMessage> handleCall($pb.ServerContext ctx,
    ...
    switch (methodName) {
      case 'AddAndDownload':
        return addAndDownload(ctx, request as $0.AddAndDownloadRequest);
      default:
        throw $core.ArgumentError('Unknown method: $methodName');
    }
  }
