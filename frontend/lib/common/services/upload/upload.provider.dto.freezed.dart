...
mixin _$UploadDto {
  ...
  @JsonKey(name: 'filename') String get fileName;

  String get assetType;

  String get assetRole;
  ...
  $UploadDtoCopyWith<UploadDto> get copyWith =>
      _$UploadDtoCopyWithImpl<UploadDto>(this as UploadDto, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType && other is UploadDto &&
            ...
            (identical(other.assetRole, assetRole) ||
                other.assetRole == assetRole) &&
...
abstract mixin class $UploadDtoCopyWith<$Res> {
  factory $UploadDtoCopyWith(UploadDto value,
      $Res Function(UploadDto) _then) = _$UploadDtoCopyWithImpl;

  @useResult
  $Res call({
    String title, String desc, @JsonKey(
        name: 'filename') String fileName, String assetType, String assetRole, String contentType, String filePath
  });
...
class _$UploadDtoCopyWithImpl<$Res>
  ...
  @override
  $Res call(
      {Object? title = null, Object? desc = null, Object? fileName = null, Object? assetType = null, Object? assetRole = null, Object? contentType = null, Object? filePath = null,}) {
    return _then(_self.copyWith(
      ...
      assetRole: null == assetRole
          ? _self.assetRole
          : assetRole // ignore: cast_nullable_to_non_nullable
      as String,
...
extension UploadDtoPatterns on UploadDto {
  ...
  TResult Function( _UploadDto value)? $default,{required TResult orElse(),}){
  final _that = this;
  switch (_that) {
...
class _UploadDto implements UploadDto {
  const _UploadDto({required this.title, required this.desc, @JsonKey(
      name: 'filename') required this.fileName, required this.assetType, required this.assetRole, required this.contentType, required this.filePath});

  factory _UploadDto.fromJson(Map<String, dynamic> json) =>
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$UploadDtoCopyWith<_UploadDto> get copyWith =>
      __$UploadDtoCopyWithImpl<_UploadDto>(this, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType && other is _UploadDto &&
            (identical(other.title, title) || other.title == title) &&
            (identical(other.desc, desc) || other.desc == desc) &&
            (identical(other.fileName, fileName) ||
                other.fileName == fileName) &&
...
/// @nodoc
abstract mixin class _$UploadDtoCopyWith<$Res>
    implements $UploadDtoCopyWith<$Res> {
  factory _$UploadDtoCopyWith(_UploadDto value,
      $Res Function(_UploadDto) _then) = __$UploadDtoCopyWithImpl;
